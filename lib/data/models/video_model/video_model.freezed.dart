...
abstract class $VideoModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String? img, String? url});
}
...
class _$VideoModelImpl implements _VideoModel {
  const _$VideoModelImpl({this.id, this.img, this.url});
  ...
  @override
  String toString() {
    return 'VideoModel(id: $id, img: $img, url: $url)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, img, url);
...
abstract class _VideoModel implements VideoModel {
  const factory _VideoModel(
      {final int? id, final String? img, final String? url}) = _$VideoModelImpl;
